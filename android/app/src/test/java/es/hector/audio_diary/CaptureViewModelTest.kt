...
class FakeBackend(private var failures:Int=0):BackendRepository {var calls=0;override suspend fun process(audio:CapturedAudio,backendUrl:String):ProcessResponse{calls++;if(failures-->0)throw java.net.ConnectException();return sampleResponse()}}
