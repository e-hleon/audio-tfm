...
8. **Limitaciones y cierre (1–2 min).** Falta validación física, batería y corpus consentido para speaker/VAD; el resultado es un prototipo reproducible y acotado, con trabajo futuro explícito.
